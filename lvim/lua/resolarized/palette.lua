-- Official colours according to https://ethanschoonover.com/solarized/
--
...
--- Colour palette according to official website
local M = {
	-- Dark background subdued (non-standard extension)
	base04  = {gui='#00262f', cterm= '8'},
	-- Dark background
	base03  = {gui='#002b36', cterm= '8'},
	-- Dark background highlights
	base02  = {gui='#073642', cterm= '0'},
	-- Dark secondary content or light emphasised content
	base01  = {gui='#586e75', cterm='10'},
	-- Light content
	base00  = {gui='#657b83', cterm='11'},
	-- Dark content
	base0   = {gui='#839496', cterm='12'},
	-- Dark emphasised content or light secondary content
	base1   = {gui='#93a1a1', cterm='14'},
	-- Light background highlights
	base2   = {gui='#eee8d5', cterm= '7'},
	-- Light background
	base3   = {gui='#fdf6e3', cterm='15'},
	-- Light background subdued (non-standard extension)
	base4   = {gui='#fff8f5', cterm='15'},
